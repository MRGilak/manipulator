...
- [main.m](main.m): joint-space dynamic simulation.
- [circle_trajectory.m](circle_trajectory.m): task-space circle tracking
- [force_motion_circle.m](force_motion_circle.m): constrained dynamics + force-motion control (end-effector constrained against the "floor").

The following shows the manipulator in action in different cases.

![alt text](images/Slotine.gif)

![alt text](images/circle.gif)

![alt text](images/circle2.gif)
...
## [Manipulator](Manipulator.m) class
...
## [circle_trajectory.m](circle_trajectory.m)
...
## [force_motion_circle.m](force_motion_circle.m)
